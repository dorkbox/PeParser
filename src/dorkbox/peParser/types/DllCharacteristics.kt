...
class DllCharacteristics(private val value: UShort, descriptiveName: String) : ByteDefinition<Array<DllCharacteristicsType>>(descriptiveName) {
    override fun get(): Array<DllCharacteristicsType> {
        return DllCharacteristicsType.get(value)
    }

    override fun format(b: StringBuilder) {
        val characteristics: Array<DllCharacteristicsType> = get()
