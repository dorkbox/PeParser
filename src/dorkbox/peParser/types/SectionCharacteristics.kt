...
class SectionCharacteristics(value: UInt, descriptiveName: String) : ByteDefinition<Array<SectionCharacteristicsType>>(descriptiveName) {
    ...
    override fun get(): Array<SectionCharacteristicsType> {
        return SectionCharacteristicsType.get(value)
    }

    override fun format(b: StringBuilder) {
        val characteristics: Array<SectionCharacteristicsType> = get()
