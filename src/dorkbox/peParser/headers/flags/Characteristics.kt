...
enum class Characteristics(private val hexValue: String, val description: String) {
    ...
    companion object {
        operator fun get(key: UShort): Array<Characteristics> {
...
//        int key = LittleEndian.Int_.fromBytes(value[0], value[1], (byte)0, (byte)0);
            ...
            val chars: MutableList<Characteristics> = ArrayList(0)
            ...
            return chars.toTypedArray<Characteristics>()
        }
    }
}
